...
func TestTransfer(t *testing.T) {
	...
	addrs := []string{
		"bitcoincash:qz0hgww8eavmkzx0gzlw7vfwa28vrtwf9vmy8cwfqq",
	}
	...
	for _, to := range addrs {
		...
		rawTx, err := testCreateTransactionStep(tm, walletID, accountID, to, "0.0005", "", nil)
		if err != nil {
			return
		}
...
func TestSummary(t *testing.T) {
	...
	walletID := "WM2KjpmtJTvqY6DZqVw7Tdwq7s71NzcLpV"
	accountID := "7oqWd7yDMzSYzpY1pQedEiKRtcUyzoRgDKXcLv4W9z2p"
	summaryAddress := "qz07qqs5lhfeclg0w3v06fewgthlfr6ukugwu2779p"
