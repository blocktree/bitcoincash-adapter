...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO BCH", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "WM2KjpmtJTvqY6DZqVw7Tdwq7s71NzcLpV")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "WM2KjpmtJTvqY6DZqVw7Tdwq7s71NzcLpV"
	account := &openwallet.AssetsAccount{Alias: "mainnetBCH", WalletID: walletID, Required: 1, Symbol: "BCH", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "WM2KjpmtJTvqY6DZqVw7Tdwq7s71NzcLpV"
	accountID := "7oqWd7yDMzSYzpY1pQedEiKRtcUyzoRgDKXcLv4W9z2p"
